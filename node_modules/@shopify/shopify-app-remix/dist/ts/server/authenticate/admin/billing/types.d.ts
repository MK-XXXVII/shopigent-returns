import { AppSubscription, BillingCheckParams, BillingCheckResponseObject, BillingRequestParams, UsageRecord } from '@shopify/shopify-api';
...
export interface CheckBillingOptions<Config extends AppConfigArg> extends Omit<BillingCheckParams, 'session' | 'plans' | 'returnObject'> {
    /**
     * The plans to check for. Must be one of the values defined in the `billing` config option.
     */
    plans?: (keyof Config['billing'])[];
...
export interface BillingContext<Config extends AppConfigArg> {
     ...
     * ```
     */
    check: <Options extends CheckBillingOptions<Config>>(options?: Options) => Promise<BillingCheckResponseObject>;
    /**
     ...
     * ```
     */
    createUsageRecord: (options: CreateUsageRecordOptions) => Promise<UsageRecord>;
    /**
     ...
     * ```
     */
    updateUsageCappedAmount: (options: UpdateUsageCappedAmountOptions) => Promise<never>;
}
