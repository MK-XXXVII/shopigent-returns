...
export interface WebhookContextWithSession<Topics = string | number | symbol> extends Context<Topics> {
    /**
...
export type WebhookContext<Topics = string | number | symbol> = WebhookContextWithoutSession<Topics> | WebhookContextWithSession<Topics>;
/**
 * Verifies requests coming from Shopify webhooks.
 * @publicDocs
 */
export type AuthenticateWebhook<Topics = string | number | symbol> = (request: Request) => Promise<WebhookContext<Topics>>;
export {};
