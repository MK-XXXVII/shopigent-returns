...
export declare const AppProxyProviderContext: import("react").Context<AppProxyProviderContextProps | null>;
/**
 ...
 * ```
 */
export declare function AppProxyProvider(props: AppProxyProviderProps): import("react").JSX.Element;
export {};
//# sourceMappingURL=AppProxyProvider.d.ts.map