...
var AppProxyProvider = require('../AppProxyProvider/AppProxyProvider.js');
 ...
 * @publicDocs
 */
const AppProxyForm = React.forwardRef(function AppProxyForm(props, ref) {
    const context = React.useContext(AppProxyProvider.AppProxyProviderContext);
    if (!context) {
        throw new Error('AppProxyForm must be used within an AppProxyProvider component');
    }
    const { children, action, ...otherProps } = props;
    return (jsxRuntime.jsx(react.Form, { action: context.formatUrl(action, false), ...otherProps, ref: ref, children: children }));
});

exports.AppProxyForm = AppProxyForm;
//# sourceMappingURL=AppProxyForm.js.map
