 ...
 * @publicDocs
 */
const AppProxyLink = React.forwardRef(function AppProxyLink(props, ref) {
    ...
    return (jsxRuntime.jsx("a", { href: context.formatUrl(href), ...otherProps, ref: ref, children: children }));
});

exports.AppProxyLink = AppProxyLink;
//# sourceMappingURL=AppProxyLink.js.map
