 ...
 * @publicDocs
 */
const AppProxyForm = forwardRef(function AppProxyForm(props, ref) {
    ...
    return (jsx(Form, { action: context.formatUrl(action, false), ...otherProps, ref: ref, children: children }));
});
