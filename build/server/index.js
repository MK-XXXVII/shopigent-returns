...
import { AppProvider, useIndexResourceState, IndexTable, Link as Link$1, Badge, Page, Layout, BlockStack, Card, Text, EmptyState, InlineStack, Button, Tag, Banner, Modal, Checkbox, TextField, List } from '@shopify/polaris';
  ...
  return /* @__PURE__ */ jsx(Page, { title: "Settings", children: /* @__PURE__ */ jsx(Layout, { children: /* @__PURE__ */ jsxs(Layout.Section, { children: [
    ...
    /* @__PURE__ */ jsx(Card, { children: /* @__PURE__ */ jsxs(BlockStack, { gap: "400", children: [
      ...
      /* @__PURE__ */ jsx(Banner, { tone: "info", children: /* @__PURE__ */ jsxs(BlockStack, { gap: "200", children: [
        /* @__PURE__ */ jsx(Text, { variant: "bodyMd", as: "p", fontWeight: "bold", children: "Supported providers:" }),
        /* @__PURE__ */ jsxs(List, { type: "bullet", children: [
          /* @__PURE__ */ jsxs(List.Item, { children: [
            /* @__PURE__ */ jsx(Text, { variant: "bodyMd", as: "span", fontWeight: "bold", children: "SendCloud" }),
            " — PostNL, DHL, DPD (EU/NL)"
          ] }),
          /* @__PURE__ */ jsxs(List.Item, { children: [
            /* @__PURE__ */ jsx(Text, { variant: "bodyMd", as: "span", fontWeight: "bold", children: "Shippo" }),
            " — UPS, FedEx, USPS (US/global)"
          ] }),
          /* @__PURE__ */ jsxs(List.Item, { children: [
            /* @__PURE__ */ jsx(Text, { variant: "bodyMd", as: "span", fontWeight: "bold", children: "EasyPost" }),
            " — UPS, FedEx, USPS, DHL, DPD (global)"
          ] })
        ] }),
        /* @__PURE__ */ jsxs(Text, { variant: "bodyMd", as: "p", children: [
